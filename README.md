# Claude standalone Android wrapper (v3)
...
- Allows document uploads through the system picker without storage permission. Blocks external main-frame links and offers to copy them.
